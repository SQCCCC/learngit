...
bestSellingList = delegator.findByAnd("WishBestSellingList", ["productStoreId" : productStoreId], UtilMisc.toList("statusId"), false);

context.bestSellingList = bestSellingList;
