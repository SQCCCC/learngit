                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active">
                                ...
                                <ul class="nav nav-third-level">
                                    ...
                                    <li>
                                        <a href="projects_Technical_Department_2#">数据部</a>
                                    </li>
                                    <li>
                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="m-b-md">
                                    <!-- <#if "${mercuryHeader.createdBy}" == "${userLogin.userLoginId}"> -->
                                        <a href="<@ofbizUrl>editProject?mercuryId=${mercuryHeader.mercuryId}</@ofbizUrl>" class="btn btn-white btn-xs pull-right">Edit project</a>
                                    <!-- <#else> -->
                                           
                                    <!-- </#if> -->
                                        <h2><strong> ${mercuryHeader.title} </strong></h2>
                                    </div>
                                    <dl class="dl-horizontal">
                                        <dt>Status:</dt> <dd><span class="label label-primary">${mercuryHeader.statusId}</span></dd>
                                    </dl>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-5">
                                    <dl class="dl-horizontal">
                                        ...
                                        <dt>Created by:</dt> <dd>${mercuryHeader.createdBy}</dd>
                                ...
                                <div class="col-lg-7" id="cluster_info">
                                    <dl class="dl-horizontal" >
                                        ...
                                        <dt>Last Updated:</dt> <dd>${mercuryHeader.lastUpdatedStamp}</dd>
                                        <dt>Created:</dt> <dd> 	${mercuryHeader.createdStamp} </dd>
                                    ...
                                    <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                            <div>
                                                ...
                                                <#if !mercuryHeader.description?has_content>描述为空<#else>${mercuryHeader.description}</#if>
                                            </div>
                                        </dd>
                                    </dl>
                                </div>
