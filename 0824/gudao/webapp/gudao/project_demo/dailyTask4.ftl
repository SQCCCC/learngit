        ...
        <div class="skin-settings">
            ...
            <div class="setings-item default-skin">
                    <span class="skin-name ">
                         <a href="http://webapplayers.com/inspinia_admin-v2.7.1/calendar.html#" class="s-skin-0">
                             Default
                         </a>
                    </span>
            </div>
            <div class="setings-item blue-skin">
                    <span class="skin-name ">
                        <a href="http://webapplayers.com/inspinia_admin-v2.7.1/calendar.html#" class="s-skin-1">
                            Blue light
                        </a>
                    </span>
            </div>
            <div class="setings-item yellow-skin">
                    <span class="skin-name ">
                        <a href="http://webapplayers.com/inspinia_admin-v2.7.1/calendar.html#" class="s-skin-3">
                            Yellow/Purple
                        </a>
                    </span>
            </div>
            <div class="setings-item ultra-skin">
                    <span class="skin-name ">
                        <a href="http://webapplayers.com/inspinia_admin-v2.7.1/md_skin/" class="md-skin">
                            Material Design
                        </a>
                    </span>
            </div>
