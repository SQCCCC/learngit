    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        ...
                        <div class="dropdown profile-element"> <span>
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="project_detail.html#">
                    ...
                    <li>
                        <a href="project_detail.html#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Graphs</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="project_detail.html#"><i class="fa fa-edit"></i> <span class="nav-label">Forms</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="project_detail.html#"><i class="fa fa-desktop"></i> <span class="nav-label">App Views</span>  <span class="pull-right label label-primary">SPECIAL</span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="contacts.html">Contacts</a></li>
                            <li><a href="profile.html">Profile</a></li>
                    ...
                    <li>
                        <a href="project_detail.html#"><i class="fa fa-files-o"></i> <span class="nav-label">Other Pages</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <li >
                        <a href="project_detail.html#"><i class="fa fa-flask"></i> <span class="nav-label">UI Elements</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="project_detail.html#"><i class="fa fa-table"></i> <span class="nav-label">Tables</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="project_detail.html#"><i class="fa fa-picture-o"></i> <span class="nav-label">Gallery</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="project_detail.html#"><i class="fa fa-sitemap"></i> <span class="nav-label">Menu Levels </span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="project_detail.html#">Third Level <span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="project_detail.html#">Third Level Item</a>
                                    </li>
                                    <li>
                                        <a href="project_detail.html#">Third Level Item</a>
                                    </li>
                            ...
                            <li><a href="project_detail.html#">Second Level Item</a></li>
                            <li>
                                <a href="project_detail.html#">Second Level Item</a></li>
                            <li>
                                <a href="project_detail.html#">Second Level Item</a></li>
                        </ul>
                    </li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    ...
                                    <li>
                                        <a href="projects.html#">人事部</a>
                                    </li>
                                    <li>
                                        <a href="projects.html#">行政部</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle count-info" data-toggle="dropdown" href="project_detail.html#">
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                ...
                                <div class="media-body">
                                    ...
                                    <small class="text-muted">3 days ago at 7:58 pm - 10.06.2016</small>
                                </div>
                            </div>
                        </li>
                        <li class="divider"></li>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-4">
                    <h2 class="textss">Project detail</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="project_demo#">Home</a>
                        </li>
                        <li>
                            <a href="projects_Technical_Department#">Category</a>
                        </li>
                        <li class="active">
        ...
        <div class="row">
                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="m-b-md">
                                        <a href="project_detail_Merchants_Department.html#" class="btn btn-white btn-xs pull-right">Edit project</a>
                                        <h2>2016年度采购协议范本</h2>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    <dl class="dl-horizontal">
                                        ...
                                        <dt>Created by:</dt> <dd>chaoxuan.tu</dd>
                                        <dt>Messages:</dt> <dd>  162</dd>
                                        <dt>Client:</dt> <dd><a href="project_detail_Merchants_Department.html#" class="text-navy"> Gudao Company</a> </dd>
                                ...
                                <div class="col-lg-7" id="cluster_info">
                                    <dl class="dl-horizontal" >
                                        ...
                                        <a href="project_detail.html"><img alt="image" class="img-circle" src="/images/project_demo/img/su.png"></a>
                                        <a href="project_detail.html"><img alt="image" class="img-circle" src="/images/project_demo/img/yasin.png"></a>
                                        <a href="project_detail.html"><img alt="image" class="img-circle" src="/images/project_demo/img/a2.jpg"></a>
                                        <a href="project_detail.html"><img alt="image" class="img-circle" src="/images/project_demo/img/a4.jpg"></a>
                                        <a href="project_detail.html"><img alt="image" class="img-circle" src="/images/project_demo/img/a5.jpg"></a>
                                        </dd>
                                    </dl>
                                </div>
                            </div>
            ...
            <div class="col-lg-3">
                <div class="wrapper wrapper-content project-manager">
                    ...
                    <img src="/images/project_demo/img/zender_logo.png" class="img-responsive">
                    <p class="small">
                    ...
                    <ul class="list-unstyled project-files">
                        ...
                        <li><a href="project_detail.html"><i class="fa fa-file"></i> Contract_20_11_2016.docx</a></li>
                    </ul>
        ...
        <div class="footer">
            ...
            <div>
                <strong>Copyright</strong> Example Company &copy; 2016-2015
            </div>
        </div>
