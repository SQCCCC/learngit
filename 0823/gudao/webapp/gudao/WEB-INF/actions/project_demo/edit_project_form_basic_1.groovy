...
context.businessTreeId = parameters.businessTreeId;
context.businessTreeType = parameters.businessTreeType;
...
if (UtilValidate.isNotEmpty(mercuryId)) {
    ...
    context.businessTreeId = mercuryHeader.businessTreeId;
    context.businessTreeType = mercuryHeader.businessTreeType;
