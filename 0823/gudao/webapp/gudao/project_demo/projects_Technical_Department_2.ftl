                            ...
                            <li>
                                ...
                                <#list businessList.childList as childList>
                                    <li >
                                        ...
                                        <a id="${childList.childId}" href='<@ofbizUrl>projects_Technical_Department_2?businessTreeId=${childList.childId}&businessTreeType=${treeType}</@ofbizUrl>#'>${childList.title}</a>
                                    </li>
                                    <!-- <li>
...
<!--     <script>window.jQuery || document.write('<script src="/images/project_demo/js/jquery-1.11.0.min.js"><\/script>')</script> -->
    ...
    <!-- Jquery Validate -->
    <script src="/images/project_demo/js/plugins/validate/jquery.validate.min.js"></script>
        <script>
